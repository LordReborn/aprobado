  ...
  return (
    <div className="settings-panel">
      ...
      <section className="settings-section">
        <h4>Exportar</h4>
        <p className="settings-desc">
          Copiá o descargá tu plan ({materiaCount} materias) para usarlo en otro dispositivo:
          exportalo acá e importalo en el otro.
        </p>
      ...
      <section className="settings-section">
        <h4>Plan de demo</h4>
        <p className="settings-desc">
          Carga el plan de Sistemas 2023 de la UTN incluido por defecto. Se reemplaza tu plan actual y se
          perderá el progreso guardado.
        </p>
        <button type="button" className="secondary-button" onClick={() => setPendingAction('demo')}>
      ...
      <section className="settings-section">
        ...
        <p className="settings-desc">
          Deja todas las materias sin marcar (ni cursando, ni regularizada ni aprobada). El plan y
          las correlativas no se modifican.
        </p>
        <button
          type="button"
      ...
      <section className="settings-section settings-section-danger">
        <h4>Eliminar todo</h4>
        <p className="settings-desc">
          Borra todas las materias del plan. El mapa quedará vacío hasta que importes o crees
          materias nuevas.
        </p>
        <button
          type="button"
